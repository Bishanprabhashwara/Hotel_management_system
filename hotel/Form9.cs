...
namespace hotel
{
    public partial class Form9 : Form
    {
        ...
        CascadeClassifier faceCasacdeClassifier = new CascadeClassifier(@"C:\Users\USER\Desktop\project\hotel\haarcascade_frontalface_alt.xml");
        ...
        #endregion
        public Form9(String empID,int form)
        {
            InitializeComponent();
            this.empID = empID;
            this.form = form;
        ...
        private void btnRecognize_Click(object sender, EventArgs e)
        {
            ...
            if (empID.Equals(label1.Text))
            {
                Form10 manag = new Form10();
                manag.Show();
                this.Close();
            }
            else
